...
#saving data for Rachel/herbicide
setwd("~/Dropbox/_Manuscripts/Dissertation/Ch. 1/Program UnMarked/MasterDataFiles")

save(DICK_Herb, file="DICK_Herb.Rdata")
load("DICK_Herb.Rdata")

save(BOBO_Herb, file="BOBO_Herb.Rdata")
save(GRSP_Herb, file="GRSP_Herb.Rdata")
save(EAME_Herb, file="EAME_Herb.Rdata")
save(RWBL_Herb, file="RWBL_Herb.Rdata")
save(HESP_Presence, file="HESP_Pres.Rdata")
save(SEWR_Presence, file="SEWR_Herb1.Rdata")
...
occu_unmarked_data = function(df) {
    ...
    SEWR_Occu=occu_unmarked_data(SEWR_Herb1)#>>Sedge Wren----
#***************************************************************************####
...
#saving data for Rachel

save(DICK_Graze, file="DICK_Graze.Rdata")
save(BOBO_Graze, file="BOBO_Graze.Rdata")
save(GRSP_Graze, file="GRSP_Graze.Rdata")
save(EAME_Graze, file="EAME_Graze.Rdata")
save(RWBL_Graze, file="RWBL_Graze.Rdata")
save(HESP_Graze, file="HESP_Graze.Rdata")
save(SEWR_Graze, file="SEWR_Graze.Rdata")
